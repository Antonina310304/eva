import React, { FC, HTMLAttributes, useMemo, useCallback, memo } from 'react';
...
const IdeasOld: FC<IdeasProps> = ({ className, title, tabGroup, products }) => {
