...
const PaymentOptions: FC<PaymentOptionsProps> = (props) => {
  ...
  return (
    <ul {...restProps} className={cn(styles.paymentsList, className)}>
      <li className={styles.paymentItem}>
        ...
        <div className={styles.paymentDescription}>
          ...
          оформлении заказа выберите способ оплаты с помощью карт Visa или Mastercard, после чего вы
      ...
      <li className={styles.paymentItem}>
        ...
        <div className={styles.paymentDescription}>
          Заказ в нашем магазине может быть оформлен в рассрочку или кредит. Подробную консультацию
          об условиях банковских программ вы можете получить у наших менеджеров. Для оформления
          продукта необходимо будет заполнить анкету. Затем ее рассмотрит кредитный специалист, и в
          случае принятия положительного решения банком вы сможете совершить покупку в рассрочку или
          кредит.
        </div>
      </li>
      <li className={styles.paymentItem}>
      ...
      <li className={styles.paymentItem}>
        ...
        <div className={styles.paymentDescription}>
          Курьер доставит вам товар по указанному адресу. Вы внимательно осматриваете комплектацию и
          внешний вид продукции, после чего оплачиваете ее стоимость, а также стоимость выбранных
          вами услуг. На привезенные изделия мы предоставим товарный чек и документацию.
        </div>
      </li>
      <li className={styles.paymentItem}>
        <div className={styles.headingWrapper}>
        ...
        <div className={styles.paymentDescription}>
          Курьер доставит вам товар по указанному адресу. Вы внимательно осматриваете комплектацию и
          внешний вид продукции, после чего оплачиваете оставшуюся часть стоимости, а также
